    ...
    <body onload="access(111)">
        <main>
            ...
            <div class="container-sm main-content">
                ...
                <div class="main-form">
                    <div class="row">
                        <div class="col-4 account-type">
                            <div class="card">
                                <div class="card-body">
                                    <p class="clickable-button"
                                       onclick="doFunction('SavingAccountDisplay')">Saving Account</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4 account-type">
                ...
                <div class="container-sm main-content">
                    <a class="btn btn-primary" onclick="openNav('deposit')">Deposit</a>
                    <a class="btn btn-primary" onclick="openNav('withdraw')">WithDraw</a>
                    <a class="btn btn-primary" onclick="openNav('save')">Save</a> <a
                        class="btn btn-primary" onclick="openNav('transfer')">Transfer</a>
                </div>
            </div>
        </main>
